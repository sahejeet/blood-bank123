...
.bodyy { background-image: url(abcd.jpg);
         width: 100%;
         color: white;
         text-align: center; }
...
.link { background-image: url(logo.jpg); 
	    width: 197px;
	    height: 52px;
	    display: block;
...
<script>
    function func1(){
        ...
        alert("You can only raise a request after you have logged in");
        
        
    }
     function func2(){
        
        alert("You can only donate after you have logged in");
...
<a class="n" href="#" onclick="func1()">RAISE A REQUEST</a>
<a class="n" href="#" onclick="func2()">DONATE BLOOD</a>
<a class="n" href="collapse.jsp">BLOOD TIPS</a> 
<a class="n" href="aboutus.jsp">ABOUT US</a>
<a class="n" href="contactus1.jsp">CONTACT US</a> 
    


</nav>
</header>
    <div class="bodyy"> fvkdfpogikokd
</div>
